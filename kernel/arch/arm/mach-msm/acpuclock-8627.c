...
static struct acpu_level acpu_freq_tbl[] __initdata = {
    ...
    { 0, { 1350000, HFPLL, 1, 0x32 }, L2(16), 1225000 },
    { 1, { 1404000, HFPLL, 1, 0x34 }, L2(16), 1237500 },
	{ 0, { 0 } }
};
