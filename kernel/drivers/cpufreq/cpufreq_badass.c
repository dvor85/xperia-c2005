...
#define BADASS_PHASE_2_PERCENT			50
...
#define BADASS_GPU_SEMI_BUSY_THRESHOLD		320
#define BADASS_GPU_BUSY_THRESHOLD		450
...
static struct bds_tuners {
	...
	.powersave_bias = 0,
#ifdef CONFIG_CPU_FREQ_GOV_BADASS_2_PHASE
	.two_phase_freq = 594000,
#endif
#ifdef CONFIG_CPU_FREQ_GOV_BADASS_3_PHASE
	.three_phase_freq = 1134000,
#endif
};
